...
public class GoalValidatorTest {
    ...
    private static final String INVALID_START_DATE_ERROR = "StartDate should be defined.\n";
    private static final String INVALID_END_DATE_ERROR = "EndDate should be defined.\n";
