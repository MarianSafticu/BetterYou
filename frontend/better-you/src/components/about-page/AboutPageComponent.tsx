  ...
  render() {
    return (
      <div className="about-page-container">
        ...
        them and feel better about yourself. But nobody reveals the most important aspect: <b>HOW</b>?
        </div>
        <div>
          We come with the answer! Use our platform to track your goals and achieve the undoable. Add goals, challenge and
          get challenged by your friends, develop great habits and discover the better <b>YOU</b>.
        </div>
      </div>
    );
  }
