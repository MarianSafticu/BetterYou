...
import "../../assets/scss/settings/RecoverAccountStyle.scss";
      ...
      <div className="main-div">
        <div className="second-div">
          <form className="form-module" action="">
            <div>Please enter your email address to recover your account:</div>
            ...
            <div className="login-button-container">
              ...
              >
                ...
                {this.state.isRestriction && (
                  <Link to="/recover-account-message" className="link">
                    Send
                  </Link>
                )}
              </Button>
